...
export default function Page() {
  ...
  // // Display All Stories 
  // const allStory = () => {
  //   axios.get(`https://iraqpad-web.vercel.app/api/story?order=created_at`).then((response) => {
  ...
  //   if (selectedCategory) {
  //     axios.get(`https://www.iraqpad.com/api/story?order=created_at?category=${selectedTitle}`).then((response) => {
