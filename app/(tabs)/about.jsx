  ...
  return (
    <View className="flex-1  pt-10  bg-slate-200 dark:bg-black">
      ...
      <View className='px-4 mt-5 w-full'>
        <Text className='text-xl text-black font-cairoBold dark:text-white'>نبذة عن عراقباد</Text>
      </View>
      <View className=' pt-5 bg-white dark:bg-[#111] flex-1 mt-5 shadow-sm rounded-t-[30]'>
        <ScrollView>
          <View className='p-4'>
            <Text className='font-cairoLight text-sm leading-[2] text-darkgray dark:text-whitegray'>
          ...
          <View className='p-4 pt-4'>
            <Text className='text-lg text-black font-cairoBold dark:text-white'>مؤسس عراقباد</Text>
